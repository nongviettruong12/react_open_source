      ...
      <div className="flex justify-center mt-[50px]">
        ...
        <div className="mr-[50px] mt-[20px]">
          ...
          <div className="text-[black]">
            <input type="text" />
            <button className="border-[1px]"><svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
